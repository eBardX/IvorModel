...
extension Work {
    ...
    /// Diminishes note attack times and durations by a rational factor for a single beat-time
    /// part in this work, along with any parameter maps selected by `applyTo`. No-ops if no part
    /// with `partID` is found.
    ///
    /// - Parameter partID:     The ID of the part to diminish.
    /// - Parameter factor:     A rational number ≥ 1 by which to compress the part’s note
    ///                         timings.
    /// - Parameter anchor:     The low beat-time bound to compress attack times relative to.
    ///                         `nil` resolves to the part’s own beat-time range.
    ...
    /// Diminishes note attack times and durations by a rational factor for a single wall-time
    /// part in this work, along with any parameter maps selected by `applyTo`. No-ops if no part
    /// with `partID` is found.
    ///
    /// - Parameter partID:     The ID of the part to diminish.
    /// - Parameter factor:     A rational number ≥ 1 by which to compress the part’s note
    ///                         timings.
    /// - Parameter anchor:     The low wall-time bound to compress attack times relative to.
    ///                         `nil` resolves to the part’s own wall-time range.
    /// - Parameter applyTo:    The parameter maps to diminish along with the note table. Defaults
    ///                         to every map.
    ///
    ...
    /// Diminishes note attack times and durations by a rational factor for a set of wall-time
    /// parts in this work, along with any parameter maps selected by `applyTo`. All-or-nothing
    /// across just the targeted parts.
    ///
    /// - Parameter partIDs:    The IDs of the parts to diminish.
    ...
    ///                         note timings.
    /// - Parameter anchor:     The low wall-time bound to compress attack times relative to.
    ///                         `nil` resolves to the aggregate wall-time range spanned by the
    ///                         targeted parts.
    /// - Parameter applyTo:    The parameter maps to diminish along with each targeted note
    ///                         table. Defaults to every map.
    ///
    ...
    /// Diminishes note attack times and durations by a rational factor across every beat-time
    /// part in this work, along with any parameter maps selected by `applyTo` and, unless
    /// `applyTo` is empty, the work’s own tempo map.
    ///
    /// - Parameter factor:     A rational number ≥ 1 by which to compress every part’s note
    ///                         timings.
    /// - Parameter anchor:     The low beat-time bound to compress attack times relative to.
    ///                         `nil` resolves to the aggregate beat-time range spanned by every
    ///                         part.
    ...
    /// Diminishes note attack times and durations by a rational factor across every wall-time
    /// part in this work, along with any parameter maps selected by `applyTo`.
    ///
    /// - Parameter factor:     A rational number ≥ 1 by which to compress every part’s note
    ///                         timings.
    /// - Parameter anchor:     The low wall-time bound to compress attack times relative to.
    ///                         `nil` resolves to the aggregate wall-time range spanned by every
    ///                         part.
