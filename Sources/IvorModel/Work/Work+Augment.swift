...
extension Work {
    ...
    /// empty, the work’s own tempo map. The tempo map is work-wide and so is carried along
    /// regardless of which parts are targeted; the note-table augmentation itself is all-or-
