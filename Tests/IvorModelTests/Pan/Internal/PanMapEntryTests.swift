...
struct PanMapEntryTests {
}

// MARK: -

extension PanMapEntryTests {
    private typealias Entry = PanMap<BeatTime>.Entry
    ...
    @Test
    func comparable() {
        let earlier = Entry(time: 1, pan: .left, extras: nil)
        let later = Entry(time: 2, pan: .right, extras: nil)
    ...
    func extras_extended() {
        ...
        let entry = Entry(time: 1, pan: .left, extras: extras)
    ...
    @Test
    func pan() {
        let entry = Entry(time: 1, pan: .right, extras: nil)
    ...
    @Test
    func time() {
        let entry = Entry(time: 3, pan: .left, extras: nil)
