...
extension DynamicMapTransformTests {
    ...
    func quantize_entryIDsRestrictsAffectedEntries() throws {
        ...
        let entryID1 = map.insert(time: 0.49, dynamic: .mp).entryID
        let entryID2 = map.insert(time: 4.49, dynamic: .mf).entryID
    ...
    func quantize_snapsTimesToGrid() throws {
        ...
        map.insert(time: 0.49, dynamic: .mp)
        map.insert(time: 3.6, dynamic: .mf)
